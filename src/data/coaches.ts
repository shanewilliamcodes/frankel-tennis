...
export const coaches: Coach[] = [
  {
    ...
    credentials: [
      ...
      "West Bloomfield High School physical education teacher; boys tennis coach for 7 years",
      "Winner of 7 USTA men's tournaments and 4 USTA senior tournaments",
    ],
    bio: [
      "Larry Stark took over the Frankel boys tennis program in 2014, and the Jaguars' modern era began almost immediately. Before his arrival, Frankel had never reached the state tournament in boys tennis. Since then, the program has become a regular Division 4 postseason qualifier and one of the school's signature teams.",
      "Before Frankel, Stark taught physical education at West Bloomfield High School and coached boys tennis there for seven years. At Frankel, he has helped turn a small-school roster into a yearly postseason factor by developing players, building doubles teams and keeping the Jaguars competitive against deeper programs.",
    ...
    honors: [
      ...
      "MHSTeCA Regional Coach of the Year at Frankel — 2016, 2022, 2025",
      "MHSTeCA Regional Coach of the Year at West Bloomfield — 2011",
