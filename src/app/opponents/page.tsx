  ...
  return (
    <>
      <PageHeader
        ...
        title="Opponents"
        subtitle="The schools we face — each scouting page has Frankel's year-by-year head-to-head record against that team, plus their 2025 team record, head coach and full roster, all pulled from TennisReporting."
      />
